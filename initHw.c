...
void initHw()
{
    ...
    GPIO_PORTB_DEN_R |= 0x20;  // enable PB5 for digital
    GPIO_PORTE_DIR_R |= 0x30;  // make bits PE4 and PE5 outputs
    GPIO_PORTE_DR2R_R |= 0x30; // set drive strength to 2mA
    GPIO_PORTE_DEN_R |= 0x30;  // enable bits PE4 and PE5 for digital
